...
public class SegmentedBar extends ProgressBar {
    ...
    public SegmentedBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SegmentedBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
